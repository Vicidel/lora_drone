...
int main(int argc, char **argv){    
    ...
    ***************************************************************************/
    ...
    // misc variables
    float precision = 1.5f;     // precision to reach the waypoints
                    ...
                    switch(state){
                        ...
                        case 1:{
                            ...
                            if(ros::Time::now() - time_last_request > ros::Duration(time_data_collection_period)){
                                ...
                                answer = send_drone_state(pos_drone, ros::Time::now().toSec(), (char*)"data", drone_id, nb_drone, true);
                            ...
                            if((pos_drone-pos_current_goal).norm()<precision){
                                ...
                                answer = send_drone_state(pos_drone, ros::Time::now().toSec(), (char*)"wp_ok_cont", drone_id, nb_drone, false);
