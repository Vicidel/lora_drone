...
int main(int argc, char **argv){    
    ...
    Vector3f pos_waypoint1     (0.0f, -3.0f, 2.0f);
    Vector3f pos_landing       (0.0f, -3.0f, 0.0f);
                ...
                switch(state){
                    ...
                    case 1:{
                        ...
                        if(ros::Time::now() - time_start_hover > ros::Duration(hover_time)){
                            ...
                            pos_current_goal = pos_waypoint1;
                            state = 2;
                        }
                    ...
                    case 2:{
                        // going into another waypoint
                        if((pos_drone-pos_current_goal).norm()<precision){
                            ROS_INFO("Waypoint 1 reached, now landing here");
                            pos_current_goal = pos_landing;
                            state = 3;
                        }
                    }
