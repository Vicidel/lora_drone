...
function output = sim2_1drone_trilateration_mod()
            ...
            case 7
                ...
                if isnan(pos_estimated(1)) || isnan(pos_estimated(2))
                    ...
                    if algo_loop == 1
                        ...
                        measure_position1 = pos_network_estimate + [size_around_estimation_v2, 0, 0];   
                        measure_position2 = pos_network_estimate + [size_around_estimation_v2*cos(angle_total/2), size_around_estimation_v2*sin(angle_total/2), 0];   
                        measure_position3 = pos_network_estimate + [size_around_estimation_v2*cos(angle_total), size_around_estimation_v2*sin(angle_total), 0];   
                    end
                else
